...
<body class="bg-black text-white">
    ...
    <nav class="bg-yellow-500 flex justify-between items-center p-4">
        <div class="flex space-x-4 gap-5 ml-56">
    ...
    <section class="relative text-center py-20 bg-[url('{{ asset('img/t.png') }}')] bg-no-repeat bg-center bg-cover h-screen">
        <div class="w-1/2">
        ...
        <div class="w-1/2 flex justify-end">
            <img src="{{ asset('img/a.png') }}" class="max-w-md">
        </div>
    </section>
</body>
</html>
